...
namespace constants
{
    ...
    const double chuteDeployAlt{80.0};      // in meters
    const double seaLevelPressure{1013.25}; // in hPa
    ...
    struct Noise
    {
        ...
        const double uncertaintyPos = 10;
        const double uncertaintyVel = 5;
    };
};
